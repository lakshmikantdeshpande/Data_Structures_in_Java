...
public class LargestRectangleUnderHistogram {
    ...
    public static int getMaxArea(int array[]) {
        ...
        while (i < array.length) {
            // if current bar is higher than or equal to stack peek, push it to
            // stack
            if (stack.empty() || array[i] >= array[stack.peek()])
                ...
                // i is right index for top and element before top in the stack
                // is left index;
                int top = stack.pop();
        ...
        // Now pop remaining bars from stack and calculate area with every
